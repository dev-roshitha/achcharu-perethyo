...
import { socialLinks, branches } from './constants';
  ...
  return (
    <footer className="w-full relative">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=1200&h=400&fit=crop")',
        }}
      />
      ...
      <div className="relative z-10 py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            {/* Left Section - Logo and Branches */}
          ...
          {/* Footer Bottom */}
          <div className="border-t border-white border-opacity-20 mt-12 sm:mt-16 pt-8">
            <p className="text-center text-blue-100 text-sm sm:text-base">
              &copy; {new Date().getFullYear()} Achcharu Perethyo. All rights
              reserved.
            </p>
          </div>
        </div>
